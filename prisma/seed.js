// CommonJS formatında admin kullanıcı oluşturma seed dosyası
...
async function main() {
  try {
    ...
    // TÜM YETKİLERİ TANIMLAMA - Şemadan alındı
    ...
    try {
      ...
      console.log('⚠️ Admin kullanıcısı temizleme hatası (önemli değil): ', error);
    }
